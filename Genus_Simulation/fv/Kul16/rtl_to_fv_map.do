...
# Generated on: Mon Nov 11 21:32:26 IST 2024 (Mon Nov 11 16:02:26 UTC 2024)
...
set_log_file fv/Kul16/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Kul16 -revised fv_map
...
add_search_path ./RTL/Kulkarni_Deisgn/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Kulkarni_Design/Kul16.v
elaborate_design -golden -root {Kul16} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Kul16/fv_map.v.gz
elaborate_design -revised -root {Kul16}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Kul16/rtl_to_fv_map.log
}
