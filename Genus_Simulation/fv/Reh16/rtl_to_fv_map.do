...
# Generated on: Mon Nov 11 21:46:05 IST 2024 (Mon Nov 11 16:16:05 UTC 2024)
...
set_log_file fv/Reh16/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Reh16 -revised fv_map
...
add_search_path ./RTL/Rehman_Deisgn/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Rehman_Design/Reh16.v
elaborate_design -golden -root {Reh16} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Reh16/fv_map.v.gz
elaborate_design -revised -root {Reh16}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Reh16/rtl_to_fv_map.log
}
