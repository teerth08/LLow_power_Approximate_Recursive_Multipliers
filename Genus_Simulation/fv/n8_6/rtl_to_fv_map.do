...
# Generated on: Mon Nov 11 22:07:40 IST 2024 (Mon Nov 11 16:37:40 UTC 2024)
...
set_log_file fv/n8_6/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/n8_6 -revised fv_map
...
add_search_path ./RTL/Zacharelos__Main_paper/8x8/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Zacharelos__Main_paper/8x8/n8_6.v
elaborate_design -golden -root {n8_6} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/n8_6/fv_map.v.gz
elaborate_design -revised -root {n8_6}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/n8_6/rtl_to_fv_map.log
}
