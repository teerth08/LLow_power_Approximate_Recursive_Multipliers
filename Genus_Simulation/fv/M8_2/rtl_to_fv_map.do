...
# Generated on: Tue Nov 12 13:38:08 IST 2024 (Tue Nov 12 08:08:08 UTC 2024)
...
set_log_file fv/M8_2/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/M8_2 -revised fv_map
...
add_search_path ./RTL/Mohammad_Saeed/M8_2/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Mohammad_Saeed/M8_2/M8_2.v
elaborate_design -golden -root {M8_2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/M8_2/fv_map.v.gz
elaborate_design -revised -root {M8_2}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/M8_2/rtl_to_fv_map.log
}
