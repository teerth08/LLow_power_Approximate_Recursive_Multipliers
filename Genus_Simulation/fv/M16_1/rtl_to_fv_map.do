...
# Generated on: Tue Nov 12 14:04:40 IST 2024 (Tue Nov 12 08:34:40 UTC 2024)
...
set_log_file fv/M16_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/M16_1 -revised fv_map
...
add_search_path ./RTL/Mohammad_Saeed/M16_5/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Mohammad_Saeed/M16_5/M16_5.v
elaborate_design -golden -root {M16_1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/M16_1/fv_map.v.gz
elaborate_design -revised -root {M16_1}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/M16_1/rtl_to_fv_map.log
}
