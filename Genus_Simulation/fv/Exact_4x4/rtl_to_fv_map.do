...
# Generated on: Tue Nov 12 12:59:24 IST 2024 (Tue Nov 12 07:29:24 UTC 2024)
...
set_log_file fv/Exact_4x4/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Exact_4x4 -revised fv_map
...
add_search_path ./RTL/Mohammad_Saeed/Exact -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Mohammad_Saeed/Exact/Exact_4x4.v
elaborate_design -golden -root {Exact_4x4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Exact_4x4/fv_map.v.gz
elaborate_design -revised -root {Exact_4x4}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Exact_4x4/rtl_to_fv_map.log
}
