...
# Generated on: Mon Nov 11 21:52:10 IST 2024 (Mon Nov 11 16:22:10 UTC 2024)
...
set_log_file fv/or_4x4/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/or_4x4 -revised fv_map
...
add_search_path ./RTL/OR_approx/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/OR_approx/or_4x4.v
elaborate_design -golden -root {or_4x4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/or_4x4/fv_map.v.gz
elaborate_design -revised -root {or_4x4}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/or_4x4/rtl_to_fv_map.log
}
