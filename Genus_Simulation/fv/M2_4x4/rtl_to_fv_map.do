...
# Generated on: Tue Nov 12 13:22:34 IST 2024 (Tue Nov 12 07:52:34 UTC 2024)
...
set_log_file fv/M2_4x4/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/M2_4x4 -revised fv_map
...
add_search_path ./RTL/Mohammad_Saeed/M2_4x4/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -mixvlog  RTL/Mohammad_Saeed/M2_4x4/M2_4x4.v
elaborate_design -golden -root {M2_4x4} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/M2_4x4/fv_map.v.gz
elaborate_design -revised -root {M2_4x4}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/M2_4x4/rtl_to_fv_map.log
}
